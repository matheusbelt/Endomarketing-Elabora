...
function odin_enqueue_scripts() {
	...
	//my js
	wp_enqueue_script( 'myjs', $template_url . '/assets/js/my-js.js');
...
function awesome_custom_post_type (){
	...
	$labels = array(
		...
		'all_items' => 'Todos Items',
		'add_new_item' => 'Adicionar Item',
		'edit_item' => 'Editar Item',
		'new_item' => 'Novo Item',
		'view_item' => 'Ver Item',
		'search_item' => 'Pesquisar Pessoas',
		'not_found' => 'Nenhum item encontrado',
		'not_found_in_trash' => 'Nenhum intem encontrado na lixeira',
	...
	register_post_type('pessoas',$args);
	...
	register_post_type('presidente',$args);
...
function imageFeatures(){
	add_image_size('bgInicial', 1350, 400, true);
}

add_action('after_setup_theme', 'imageFeatures');